...
public final class ModRuntime {
    ...
    /** HUD "current keyboard always shown" tab (loader-agnostic draw hook, GuiGraphics based). */
    public static void onHudRender(net.minecraft.client.gui.GuiGraphics gui, float delta) {
