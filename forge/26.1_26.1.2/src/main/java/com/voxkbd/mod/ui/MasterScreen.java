 ...
 * rendering via GuiGraphicsExtractor, clicks via the classic double/int handlers).
 */
public final class MasterScreen extends VoxScreen {
    ...
    public void extractRenderState(GuiGraphicsExtractor gui, int mouseX, int mouseY, float delta) {
        ...
        gui.text(font, this.title, SIDE_PAD, (TOP_BAR_H - 9) / 2, ACCENT, false);
        ...
        gui.text(font, activeLabel, this.width - tw - SIDE_PAD, (TOP_BAR_H - 9) / 2, TEXT, false);
        ...
        gui.text(font, Component.translatable("voxkbd.ui.help.click"),
        ...
        if (warnMessage != null) {
            if (System.currentTimeMillis() < warnUntilMs) {
                ...
                gui.text(font, warnMessage, this.width / 2 - ww / 2, by - 17, 0xFFFF7B7B, false);
            } else {
                warnMessage = null;
            }
        }
        ...
        for (Cell cell : cells) {
            ...
            if (scale >= 0.999f) {
                gui.centeredText(font, label, cx, cy - 4, isLocked ? 0xFFFFFFFF : TEXT);
            } else {
    ...
    private void drawZoneBox(GuiGraphicsExtractor gui, Font font, Component caption,
        ...
        gui.text(font, caption, tx, y + 4, TEXT_DIM, false);
    }
    ...
    @Override
    public boolean mouseClicked(net.minecraft.client.input.MouseButtonEvent ev, boolean doubled) {
